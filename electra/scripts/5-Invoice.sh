...
####################################################################################################################################
# electrad tx meter create-customerbillingline [customerdevice-id] [cycle-id] [paid] [lineid] [producer-device-id] [bill-contract-id] [line-wh] [line-wh-price] [curency] [decremented] [phase] [reference-price] [savings] [flags]
# electrad tx meter create-producerbillingline [producer-device-id] [cycle-id] [paid] [lineid] [customerdevice-id] [bill-contract-id] [line-wh] [line-wh-price] [curency] [decremented] [phase] [flags]

# 
lineid=1
echo $test1 $prod1 $lineid
read -p "Press key to continue.. " -n1 -s
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test1-prod1" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
...
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test1-prod2" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
electrad tx meter create-producerbillingline $prod1 $cycle $lineid false $test1 "test1-prod2" 1000 6600 "stTH" 1000 1 --from bob -y | grep "raw_log: 'failed"
((lineid++)) # Increment the lineid
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test2-prod1" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
...
((lineid++)) # Increment the lineid
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test2-prod2" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
electrad tx meter create-producerbillingline $prod1 $cycle $lineid false $test1 "test2-prod2" 1000 6600 "stTH" 1000 1 --from bob -y | grep "raw_log: 'failed"
((lineid++)) # Increment the lineid
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test3-prod1" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
electrad tx meter create-producerbillingline $prod1 $cycle $lineid false $test1 "test3-prod1" 1000 6600 "stTH" 1000 1 --from bob -y | grep "raw_log: 'failed"
((lineid++)) # Increment the lineid
electrad tx meter create-customerbillingline $test1 $cycle $lineid false $prod1 "test3-prod2" 1000 6600 "stTH" 1000 1 7700 1100 --from bob -y | grep "raw_log: 'failed"
electrad tx meter create-producerbillingline $prod1 $cycle $lineid false $test1 "test3-prod2" 1000 6600 "stTH" 1000 1 --from bob -y | grep "raw_log: 'failed"
read -p "Press key to continue.. " -n1 -s
# Control
Echo "============ Customer ============"
...
electrad tx meter create-customerbills $cycle $test1 $(date '+%s') 1000 6690 "stTH" true false --from bob -y | grep "raw_log: 'failed"
...
electrad tx meter create-producerbills $cycle $prod1 $(date '+%s') 1000 6690 "stTH" true false --from bob -y | grep "raw_log: 'failed"
...
electrad query meter currentcycle-id | grep "cycleID:"
# Usage:  electrad tx meter prepare-bill [cycle-id] [record] [execute-payment] [flags]
electrad tx meter prepare-bill $cycle false false --from bob -y
