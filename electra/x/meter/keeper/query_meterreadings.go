...
func (k Keeper) MeterreadingsAll(goCtx context.Context, req *types.QueryAllMeterreadingsRequest) (*types.QueryAllMeterreadingsResponse, error) {
	if req == nil {
...
func (k Keeper) Meterreadings(goCtx context.Context, req *types.QueryGetMeterreadingsRequest) (*types.QueryGetMeterreadingsResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
