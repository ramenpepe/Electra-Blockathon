...
func (k Keeper) CustomerbillsAll(goCtx context.Context, req *types.QueryAllCustomerbillsRequest) (*types.QueryAllCustomerbillsResponse, error) {
	if req == nil {
...
func (k Keeper) Customerbills(goCtx context.Context, req *types.QueryGetCustomerbillsRequest) (*types.QueryGetCustomerbillsResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
