...
func (k Keeper) PpaMapAll(goCtx context.Context, req *types.QueryAllPpaMapRequest) (*types.QueryAllPpaMapResponse, error) {
	if req == nil {
...
func (k Keeper) PpaMap(goCtx context.Context, req *types.QueryGetPpaMapRequest) (*types.QueryGetPpaMapResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
