...
func (k Keeper) BillingcyclesAll(goCtx context.Context, req *types.QueryAllBillingcyclesRequest) (*types.QueryAllBillingcyclesResponse, error) {
	if req == nil {
...
func (k Keeper) Billingcycles(goCtx context.Context, req *types.QueryGetBillingcyclesRequest) (*types.QueryGetBillingcyclesResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
