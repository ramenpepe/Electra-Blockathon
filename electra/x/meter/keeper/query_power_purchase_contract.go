...
func (k Keeper) PowerPurchaseContractAll(goCtx context.Context, req *types.QueryAllPowerPurchaseContractRequest) (*types.QueryAllPowerPurchaseContractResponse, error) {
	if req == nil {
...
func (k Keeper) PowerPurchaseContract(goCtx context.Context, req *types.QueryGetPowerPurchaseContractRequest) (*types.QueryGetPowerPurchaseContractResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
