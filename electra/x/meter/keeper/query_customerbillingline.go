...
func (k Keeper) CustomerbillinglineAll(goCtx context.Context, req *types.QueryAllCustomerbillinglineRequest) (*types.QueryAllCustomerbillinglineResponse, error) {
	if req == nil {
...
func (k Keeper) Customerbillingline(goCtx context.Context, req *types.QueryGetCustomerbillinglineRequest) (*types.QueryGetCustomerbillinglineResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
