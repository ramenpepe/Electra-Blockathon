...
func (k Keeper) MeterdirectoryAll(goCtx context.Context, req *types.QueryAllMeterdirectoryRequest) (*types.QueryAllMeterdirectoryResponse, error) {
	if req == nil {
...
func (k Keeper) Meterdirectory(goCtx context.Context, req *types.QueryGetMeterdirectoryRequest) (*types.QueryGetMeterdirectoryResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
