...
func (k Keeper) ProducerbillinglineAll(goCtx context.Context, req *types.QueryAllProducerbillinglineRequest) (*types.QueryAllProducerbillinglineResponse, error) {
	if req == nil {
...
func (k Keeper) Producerbillingline(goCtx context.Context, req *types.QueryGetProducerbillinglineRequest) (*types.QueryGetProducerbillinglineResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(goCtx)
